...
## [0.95.0](https://github.com/tiborsimko/reana-workflow-engine-cwl/compare/0.9.4...0.95.0) (2026-09-22)
...
* **python:** pin setuptools below 81 ([#310](https://github.com/tiborsimko/reana-workflow-engine-cwl/issues/310)) ([95066f9](https://github.com/tiborsimko/reana-workflow-engine-cwl/commit/95066f954ff47dd6cd0fd9134d1c2145ac15b49a))
...
* **cwl_reana:** pass K8s requests/limits to job controller ([#292](https://github.com/tiborsimko/reana-workflow-engine-cwl/issues/292)) ([556fbef](https://github.com/tiborsimko/reana-workflow-engine-cwl/commit/556fbef9287b84c557bcf1b89401fca0f62f4825))
* **cwl_reana:** pass K8s requests/limits to job controller ([#292](https://github.com/tiborsimko/reana-workflow-engine-cwl/issues/292)) ([2170e33](https://github.com/tiborsimko/reana-workflow-engine-cwl/commit/2170e33658b34a795c14bd9cda40e6d00ebb84f0))
...
* **task:** pass HTCondor CPU/memory/disk/requirements hints ([#316](https://github.com/tiborsimko/reana-workflow-engine-cwl/issues/316)) ([b6dd106](https://github.com/tiborsimko/reana-workflow-engine-cwl/commit/b6dd10690b1caf4d9841ff4e4e96b6172e308e94))


### Bug fixes

* **config:** use glob for egg-info in flake8 exclude ([#314](https://github.com/tiborsimko/reana-workflow-engine-cwl/issues/314)) ([9db2c15](https://github.com/tiborsimko/reana-workflow-engine-cwl/commit/9db2c1553e32ba202d211e98aa0860b97d9ee419))
* **cwl_reana:** preserve inplace update symlinks ([#322](https://github.com/tiborsimko/reana-workflow-engine-cwl/issues/322)) ([6a43f16](https://github.com/tiborsimko/reana-workflow-engine-cwl/commit/6a43f16108b0afaea6ef8195e65b3b920ca5f6c9))
* **cwl_reana:** preserve staged inputs during output copy ([#322](https://github.com/tiborsimko/reana-workflow-engine-cwl/issues/322)) ([95a837a](https://github.com/tiborsimko/reana-workflow-engine-cwl/commit/95a837a5ab58986de9195a79296f42efae771b46))
* **git:** update .gitignore to exclude modules directory ([#315](https://github.com/tiborsimko/reana-workflow-engine-cwl/issues/315)) ([3003214](https://github.com/tiborsimko/reana-workflow-engine-cwl/commit/30032141ff1ca8c353dba37409bb2da5a0ab95b8))
...
* **main:** replace deprecated pkg_resources ([#302](https://github.com/tiborsimko/reana-workflow-engine-cwl/issues/302)) ([a565875](https://github.com/tiborsimko/reana-workflow-engine-cwl/commit/a56587501ac39c07c9e7ae883d16bbb74f8dc422))
* **pytest:** drop pytest-reana and use pytest directly ([#313](https://github.com/tiborsimko/reana-workflow-engine-cwl/issues/313)) ([927fab1](https://github.com/tiborsimko/reana-workflow-engine-cwl/commit/927fab13984b90d6a6e4a04322befdeff3508863))


### Code style

* **python:** adapt code base to the new black version ([#310](https://github.com/tiborsimko/reana-workflow-engine-cwl/issues/310)) ([27b1883](https://github.com/tiborsimko/reana-workflow-engine-cwl/commit/27b188329bfbda5299e4fa7caf679df428df4887))
...
* **markdownlint:** less permissive global configuration ([#311](https://github.com/tiborsimko/reana-workflow-engine-cwl/issues/311)) ([d260fcf](https://github.com/tiborsimko/reana-workflow-engine-cwl/commit/d260fcfbe54455964f8cc68445375ff8a5187b3a))
...
* **release-please:** update version in Dockerfile ([#259](https://github.com/tiborsimko/reana-workflow-engine-cwl/issues/259)) ([0961257](https://github.com/tiborsimko/reana-workflow-engine-cwl/commit/096125709172e6bea1510a9fd2fdcb90299fac8b))
* **release-please:** upgrade action to v5 ([#323](https://github.com/tiborsimko/reana-workflow-engine-cwl/issues/323)) ([2ad2e8e](https://github.com/tiborsimko/reana-workflow-engine-cwl/commit/2ad2e8e79b110a9070dd980dd039c4e1378f6a27))
...
* **run-tests:** add usage help and refactor options ([#311](https://github.com/tiborsimko/reana-workflow-engine-cwl/issues/311)) ([104d810](https://github.com/tiborsimko/reana-workflow-engine-cwl/commit/104d8105f120e5ff0ffe59edbfa136c3becc57ee))
* **runners:** upgrade CI runners to Ubuntu 22.04 ([#294](https://github.com/tiborsimko/reana-workflow-engine-cwl/issues/294)) ([556fbef](https://github.com/tiborsimko/reana-workflow-engine-cwl/commit/556fbef9287b84c557bcf1b89401fca0f62f4825))
* **runners:** upgrade CI runners to Ubuntu 22.04 ([#294](https://github.com/tiborsimko/reana-workflow-engine-cwl/issues/294)) ([d308fd5](https://github.com/tiborsimko/reana-workflow-engine-cwl/commit/d308fd5e9e3eea4f5579f3489e8a27b076fa0b61))
